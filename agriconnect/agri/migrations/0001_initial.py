# Generated by Django 5.0.3 on 2024-03-09 05:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('village', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='farms', to='agri.village')),
                ('farmer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='farms', to='agri.farmer')),
            ],
        ),
        migrations.CreateModel(
            name='Authority',
            fields=[
                ...
                ('farms', models.ManyToManyField(related_name='authorities', to='agri.farmer')),
            ],
            options={
                'verbose_name': 'user',
                'verbose_name_plural': 'users',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('distribution_location', django.contrib.gis.db.models.fields.PointField(srid=4326)),
